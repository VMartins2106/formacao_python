...
__all__ = [
    ...
    'DISPID_SpeechRecoResult', 'SpeechDiscardType',
    'SpeechGrammarTagDictation', 'SVEPhoneme', 'SVEViseme',
    'SpeechVoiceEvents', 'DISPID_SLRemovePronunciationByPhoneIds',
    'ISpRecoGrammar2', 'DISPID_SRGReset', 'SRTStandard',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'ISpeechRecoResult',
    'SpeechVoicePriority', 'eLEXTYPE_RESERVED6',
    'SAFTGSM610_22kHzMono', 'DISPID_SVSPhonemeId',
    'DISPID_SGRAddResource', 'SPCS_ENABLED',
    'SpeechRetainedAudioOptions', 'SpeechCategoryAudioOut',
    'SpeechRunState', 'SGDisplay', 'DISPID_SLPSymbolic',
    'DISPID_SRRAudioFormat', 'SAFTCCITT_uLaw_11kHzMono',
    'DISPID_SRRTStreamTime', 'SPEI_VOICE_CHANGE', 'SPFILEMODE',
    'DISPID_SRCCmdMaxAlternates', 'DISPID_SPARecoResult',
    'SPEI_SENTENCE_BOUNDARY', 'DISPID_SPACommit',
    'ISpeechWaveFormatEx', 'SPWORDPRONOUNCEABLE',
    'SPDKL_CurrentConfig', 'SPWORDTYPE', 'DISPID_SpeechPhraseRule',
    'SpeechDisplayAttributes', 'DISPID_SPPId', 'ISpeechVoice',
    'DISPID_SOTId', 'DISPID_SRGetPropertyNumber',
    'DISPID_SVDisplayUI', 'DISPID_SPRDisplayAttributes',
    'DISPID_SPIElements', 'DISPID_SRRAudio', 'SpWaveFormatEx',
    'SPEI_SOUND_END', 'ISpeechGrammarRules', 'eLEXTYPE_PRIVATE5',
    'DISPID_SASCurrentSeekPosition', 'SPAR_High', 'DISPID_SLWsCount',
    'SPSUnknown', 'DISPID_SRCState', 'SVF_None',
    'SpeechGrammarRuleStateTransitionType', 'SpMemoryStream',
    'DISPID_SRCEEnginePrivate', 'DISPID_SGRsCommit',
    'SPSEMANTICERRORINFO', 'SASStop', 'DISPID_SPIGetText',
    'DISPID_SLAddPronunciation', 'SPEI_TTS_PRIVATE',
    'DISPID_SVSInputWordPosition', 'DISPID_SPPsItem', 'SVSFNLPMask',
    'SAFTCCITT_ALaw_8kHzMono', 'SAFT24kHz8BitMono',
    'DISPID_SABIBufferSize', 'eLEXTYPE_PRIVATE9',
    'DISPID_SpeechBaseStream', 'SVSFUnusedFlags',
    ...
    'DISPID_SpeechGrammarRule', 'SPEI_RECO_OTHER_CONTEXT',
    'DISPID_SPEDisplayText', 'SPLOADOPTIONS',
    'DISPID_SpeechRecoContextEvents', 'DISPID_SOTCGetDataKey',
    'SRSInactiveWithPurge', 'SGRSTTTextBuffer', 'SAFT22kHz8BitMono',
    'DISPIDSPTSI_SelectionLength', 'SPEI_RECO_STATE_CHANGE',
    'SpStreamFormatConverter', 'SSFMCreateForWrite',
    'eLEXTYPE_RESERVED8', 'ISpeechRecognizerStatus',
    'DISPID_SLWPronunciations', 'DISPID_SRGCmdLoadFromObject',
    'DISPID_SBSFormat', 'SP_VISEME_19', 'SpeechVoiceSpeakFlags',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SPINTERFERENCE_TOOSLOW', 'ISpNotifyTranslator',
    'IInternetSecurityManager', 'ISpeechGrammarRuleStateTransitions',
    'eLEXTYPE_PRIVATE15', 'DISPID_SRCCreateGrammar', 'SREHypothesis',
    'SREBookmark', 'SpeechInterference',
    'DISPIDSPTSI_SelectionOffset', '_ISpeechVoiceEvents',
    'SpeechSpecialTransitionType', 'DISPID_SRCESoundStart',
    'DISPID_SRRGetXMLResult', 'DISPID_SRRTimes', 'ISpeechPhraseInfo',
    'SPVPRIORITY', 'SpeechPropertyResourceUsage', 'SPCT_COMMAND',
    'DISPID_SVEStreamStart', 'SPRST_INACTIVE',
    'DISPID_SPIEnginePrivateData', 'DISPID_SVSLastBookmarkId',
    'SPAUDIOSTATE', 'STCRemoteServer', 'DISPID_SFSClose',
    'ISpeechPhraseProperties', 'DISPID_SBSWrite',
    'SAFTADPCM_44kHzStereo', 'SINoise', 'SPRULESTATE',
    'DISPID_SVSpeak', 'SAFTADPCM_8kHzStereo', 'SpeechStreamFileMode',
    'DISPID_SGRSRule', 'DISPID_SPEsCount', 'DISPID_SRCEAudioLevel',
    'ISpeechResourceLoader', 'DISPID_SRCVoicePurgeEvent',
    'eLEXTYPE_MORPHOLOGY', 'DISPID_SRRAlternates',
    'DISPID_SpeechXMLRecoResult', 'SRERecognition', 'SP_VISEME_20',
    'DISPID_SOTRemove', 'DISPID_SpeechObjectTokens', 'SASPause',
    'SRSActive', 'DISPID_SRCreateRecoContext', 'DISPID_SPRuleName',
    'eLEXTYPE_LETTERTOSOUND', 'SDTRule', 'SPPS_RESERVED1',
    'SPAR_Medium', 'SDA_One_Trailing_Space', 'SSSPTRelativeToStart',
    'SP_VISEME_16', 'DISPID_SRRPhraseInfo', 'UINT_PTR',
    ...
    'eLEXTYPE_PRIVATE10', 'DISPID_SRCEFalseRecognition',
    'DISPID_SPEEngineConfidence', 'DISPID_SASetState', 'SP_VISEME_1',
    'SPEI_RESERVED6', 'SPEI_PROPERTY_NUM_CHANGE',
    'DISPID_SLPPhoneIds', 'DISPID_SMSADeviceId', 'SPSEMANTICFORMAT',
    'SVPOver', 'DISPID_SGRsItem', 'DISPID_SPRuleId', 'DISPID_SVPause',
    'SAFTCCITT_ALaw_44kHzMono', 'SPEI_RESERVED1',
    'ISpeechPhraseAlternates', 'SPVPRI_NORMAL',
    'DISPID_SRSAudioStatus', 'SAFTADPCM_22kHzStereo',
    'SpeechPropertyHighConfidenceThreshold', 'DISPID_SPIRule',
    'Speech_Default_Weight', 'DISPID_SRCRetainedAudioFormat',
    'SVP_11', 'DISPID_SRGetPropertyString', 'SpeechRecoContextState',
    'SPCS_DISABLED', 'DISPID_SRIsShared', 'DISPID_SpeechAudio',
    'SVF_Stressed', 'DISPID_SRGSetTextSelection',
    'DISPID_SPPs_NewEnum', 'SpeechRegistryUserRoot', 'SRAONone',
    'SpResourceManager', 'SPEI_RESERVED5', 'DISPID_SRRSaveToMemory',
    'DISPID_SVRate', 'SPEI_START_SR_STREAM',
    'SpeechPropertyNormalConfidenceThreshold', 'DISPID_SVStatus',
    'SAFTADPCM_11kHzMono', 'ISpRecognizer2', 'SpeechTokenContext',
    'DISPID_SOTCDefault', 'SPWT_PRONUNCIATION', 'SGSEnabled',
    'SPGS_DISABLED', 'SSSPTRelativeToCurrentPosition',
    'SRAORetainAudio', 'SVSFParseSapi', 'SpeechEngineProperties',
    'SAFTGSM610_44kHzMono', 'DISPID_SPRuleConfidence',
    'DISPID_SASCurrentDevicePosition', 'SVP_10',
    'ISpeechPhraseInfoBuilder', 'SITooQuiet', 'SDKLCurrentConfig',
    'SVSFPersistXML', 'SAFTTrueSpeech_8kHz1BitMono', 'SPEI_MAX_TTS',
    'SAFT48kHz8BitStereo', 'SPBINARYGRAMMAR', 'DISPID_SPAsCount',
    'DISPID_SRSCurrentStreamPosition', 'DISPID_SPRsItem',
    'SpeechCategoryVoices', 'DISPID_SVGetAudioInputs',
    'DISPID_SpeechLexiconProns', 'DISPID_SPILanguageId', 'SGRSTTWord',
    'SPXRO_Alternates_SML', 'DISPID_SGRSAddRuleTransition',
    'SVEWordBoundary', 'SPFM_NUM_MODES', 'ISpeechAudioBufferInfo',
    'SDA_Two_Trailing_Spaces', 'SPAR_Low', 'SAFT32kHz8BitMono',
    'SPEI_MAX_SR', 'SRSEDone', 'DISPID_SpeechObjectToken', 'SVP_13',
    'DISPID_SVSCurrentStreamNumber', 'DISPID_SpeechAudioFormat',
    'SPWORD', 'SPDKL_CurrentUser', 'DISPID_SVSRunningState',
    'DISPID_SPIReplacements', 'SPGS_EXCLUSIVE', 'SPPS_LMA',
    'SPPS_Verb', 'SREPropertyStringChange', 'SPSTREAMFORMATTYPE',
    'DISPID_SPPValue', 'SINone', 'SREFalseRecognition',
    'SGSExclusive', 'DISPID_SpeechVoiceStatus',
    'DISPID_SDKSetBinaryValue', 'DISPID_SGRSAddSpecialTransition',
    'ISpAudio', 'ISpeechPhoneConverter', 'eLEXTYPE_PRIVATE1',
    'SpeechAudioState', 'SSFMOpenForRead', 'DISPID_SDKEnumKeys',
    'DISPID_SDKEnumValues', 'ISpRecoCategory', 'SPEI_SR_BOOKMARK',
    'SAFTCCITT_ALaw_11kHzStereo', 'DISPID_SVResume',
    'SPXMLRESULTOPTIONS', 'SAFT24kHz8BitStereo', 'SPXRO_SML',
    'SDTDisplayText', 'SP_VISEME_21', 'DISPID_SPERequiredConfidence',
    'DISPID_SGRSTRule', 'ISpResourceManager', 'SPPS_RESERVED2',
    'SPPS_RESERVED3', 'SVP_6', 'SpeechVisemeType', 'SPPS_Noncontent',
    'SPEI_PROPERTY_STRING_CHANGE', 'Speech_StreamPos_Asap',
    'SGLexicalNoSpecialChars', 'DISPID_SPIEngineId', 'DISPID_SGRId',
    'ISpObjectTokenCategory', 'DISPID_SRGCmdLoadFromFile',
    'eLEXTYPE_PRIVATE8', 'SPCT_DICTATION', 'SREPrivate', 'SVP_2',
    'DISPID_SpeechPhraseRules', 'STSF_FlagCreate',
    'ISpeechLexiconWord', 'DISPID_SpeechPhraseReplacements',
    'SAFT8kHz8BitMono', 'DISPID_SDKDeleteKey', 'DISPID_SRGRules',
    'SVP_15', 'SP_VISEME_18',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'SPEI_FALSE_RECOGNITION', 'SGDSInactive',
    'ISpeechLexiconPronunciation', 'SAFT16kHz16BitStereo',
    'ISpRecognizer3', 'SDA_No_Trailing_Space', 'SAFT16kHz8BitMono',
    'ISpVoice', 'DISPID_SOTMatchesAttributes', 'eLEXTYPE_PRIVATE2',
    'SpCustomStream', 'SPPHRASEREPLACEMENT', 'DISPID_SRRTLength',
    'SpeechGrammarTagUnlimitedDictation', 'DISPID_SABufferInfo',
    'SPPHRASEPROPERTY', 'DISPID_SPCIdToPhone', 'SVP_19',
    'DISPID_SpeechPhraseAlternates', 'DISPID_SVSVisemeId',
    'DISPID_SRGetRecognizers', 'SPVISEMES', 'SINoSignal',
    'DISPID_SPPChildren', 'ISpeechObjectToken',
    'SpTextSelectionInformation', 'DISPID_SRCEStartStream',
    'eWORDTYPE_ADDED', 'Speech_Max_Word_Length', 'SPRS_ACTIVE',
    'SpeechDictationTopicSpelling', 'DISPID_SGRSTPropertyValue',
    'SPPHRASERULE', 'SVP_4', 'SRSEIsSpeaking',
    'IInternetSecurityMgrSite', 'SSSPTRelativeToEnd',
    'ISpeechLexicon', 'DISPID_SGRSTPropertyName',
    'SAFTCCITT_uLaw_8kHzMono', 'SBONone', 'DISPID_SPEsItem',
    'DISPID_SPRuleNumberOfElements', 'DISPID_SPRs_NewEnum',
    'SGRSTTEpsilon', 'DISPID_SABufferNotifySize',
    'SPSERIALIZEDPHRASE', 'SVSFNLPSpeakPunc', 'DISPID_SDKOpenKey',
    'DISPID_SVSLastBookmark', 'DISPID_SAVolume',
    'DISPID_SRSetPropertyString', 'DISPID_SASNonBlockingIO',
    'SPSNotOverriden', 'ISpeechPhraseReplacement',
    'Speech_Max_Pron_Length', 'DISPID_SPIGetDisplayAttributes',
    'DISPID_SpeechPhraseProperties', 'DISPID_SPISaveToMemory',
    'SpeechCategoryRecoProfiles', 'SAFT12kHz8BitMono',
    'STSF_LocalAppData', 'DISPID_SLWLangId', 'SP_VISEME_8',
    'SpeechVoiceCategoryTTSRate', 'ISpGrammarBuilder', 'SGSDisabled',
    'SLTUser', 'DISPID_SPRuleEngineConfidence',
    'DISPID_SPEDisplayAttributes', 'SWPKnownWordPronounceable',
    'SVP_7', 'SPSMF_UPS', 'DISPID_SPEActualConfidence',
    'SPGS_ENABLED', 'ISpStream', 'SASRun', 'SVEBookmark',
    'SP_VISEME_11', 'DISPID_SRCEAdaptation',
    'DISPID_SPEAudioTimeOffset', 'eLEXTYPE_PRIVATE13',
    'SpeechVoiceSkipTypeSentence', 'SP_VISEME_12',
    'SpeechUserTraining', 'ISpPhoneConverter',
    'DISPID_SRGDictationSetState', 'SVP_0', 'DISPID_SRRecognizer',
    'SAFT44kHz16BitStereo', 'DISPID_SPRuleFirstElement',
    'SPSFunction', 'SPINTERFERENCE',
    'DISPID_SRCEPropertyStringChange', 'SPAUDIOOPTIONS',
    'SpeechRuleState', 'SpeechWordPronounceable', 'SPEI_REQUEST_UI',
    'SWPUnknownWordPronounceable', 'SAFT32kHz16BitMono',
    'SECFIgnoreWidth', 'SGLexical', 'DISPID_SPEPronunciation',
    'SpeechTokenKeyUI', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'SpeechLoadOption', 'SAFTExtendedAudioFormat', 'SVP_9',
    'SPLO_STATIC', 'SVP_3', 'ISequentialStream', 'SGRSTTWildcard',
    ...
    'DISPID_SOTIsUISupported', 'SFTSREngine', 'SRARoot',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SPRULE', 'SpeechGrammarState',
    'SVEAudioLevel', 'SAFT22kHz16BitStereo', 'DISPID_SGRSTText',
    'DISPID_SpeechLexicon', 'SpeechAudioFormatGUIDText',
    'SECFEmulateResult', 'SAFTADPCM_11kHzStereo', 'SREStateChange',
    ...
    'SpUnCompressedLexicon', 'SECLowConfidence',
    'DISPID_SCSBaseStream', 'SPCT_SUB_COMMAND', 'SECFNoSpecialChars',
    'SITooLoud', 'DISPID_SPRules_NewEnum', 'DISPID_SPEAudioSizeBytes',
    'SRAExport', 'SRTExtendableParse', 'SPINTERFERENCE_TOOLOUD',
    'SPSModifier', 'SpeechPropertyComplexResponseSpeed',
    'DISPID_SDKGetlongValue', 'SpeechRecoProfileProperties', 'SDTAll',
    'DISPID_SPCPhoneToId', 'SVEAllEvents', 'DISPID_SGRSTType',
    'DISPID_SVGetVoices', 'DISPID_SOTCEnumerateTokens', 'ISpPhrase',
    'WAVEFORMATEX', 'SREPropertyNumChange', 'SVSFIsXML',
    'DISPID_SPANumberOfElementsInResult', 'DISPID_SGRsAdd',
    'DISPID_SPIGrammarId', 'SVSFPurgeBeforeSpeak', 'SVEVoiceChange',
    'SpeechPropertyResponseSpeed', 'SPSHT_OTHER',
    'SPADAPTATIONRELEVANCE', 'ISpPhoneticAlphabetSelection',
    'SPBO_NONE', 'ISpeechMemoryStream', 'DISPID_SRCResume',
    'DISPID_SGRSTsItem', 'SREInterference', 'DISPID_SRCPause',
    'ISpEventSource', 'SSFMOpenReadWrite', 'SRTEmulated',
    'eLEXTYPE_PRIVATE16', 'SPWORDLIST',
    'DISPID_SRCEPropertyNumberChange', 'DISPID_SVEViseme',
    'eLEXTYPE_PRIVATE14', 'DISPID_SVEVoiceChange',
    'SPEI_TTS_BOOKMARK', 'SPRECOSTATE', 'ISpeechPhraseAlternate',
    'SAFTText', 'DISPID_SPEAudioStreamOffset',
    'DISPIDSPTSI_ActiveOffset', 'DISPID_SLPPartOfSpeech',
    'DISPID_SRGState', 'SAFTADPCM_44kHzMono', 'SVP_18', 'SPAS_RUN',
    'SPVPRI_OVER', 'DISPID_SpeechDataKey', 'DISPID_SRGId', 'SFTInput',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'DISPID_SRRGetXMLErrorInfo', 'DISPID_SRCVoice',
    'DISPID_SADefaultFormat', 'DISPID_SGRName', 'SpLexicon',
    'SPEI_PHONEME', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'DISPID_SABIEventBias', 'SPGRAMMARWORDTYPE', 'ISpeechGrammarRule',
    'SPEI_SR_PRIVATE', 'ISpDataKey', 'ISpeechXMLRecoResult',
    'SpeechRecognizerState', 'SpNullPhoneConverter',
    'DISPID_SVEStreamEnd', 'DISPID_SRGetFormat',
    'ISpeechObjectTokens', 'SPFM_OPEN_READWRITE',
    'DISPID_SRGCmdLoadFromMemory', 'DISPID_SRAudioInput',
    'SPINTERFERENCE_LATENCY_WARNING', 'ISpRecognizer',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SAFT48kHz16BitMono',
    'SECFIgnoreCase', 'SPSMF_SRGS_SAPIPROPERTIES',
    'DISPID_SDKCreateKey', 'SpeechAudioVolume', 'SpeechTokenKeyFiles',
    'DISPID_SGRSTPropertyId', 'DISPID_SRSCurrentStreamNumber',
    'SPAS_CLOSED', 'ISpShortcut', 'SPEI_SR_RETAINEDAUDIO',
    'SRSActiveAlways', 'SDTReplacement', 'DISPID_SGRSTransitions',
    'DISPID_SVEBookmark', 'DISPID_SWFEExtraData',
    'eLEXTYPE_PRIVATE20', 'ISpeechAudio', 'DISPID_SRGDictationLoad',
    'ISpStreamFormat', 'SpCompressedLexicon',
    'DISPID_SPIAudioSizeBytes', 'SPEI_MIN_TTS', 'DISPID_SOTSetId',
    'SpeechGrammarWordType', 'SPPROPERTYINFO', 'DISPID_SLPsCount',
    'SpeechDataKeyLocation', 'SAFT44kHz8BitStereo', 'DISPID_SVVoice',
    'DISPID_SLAddPronunciationByPhoneIds', 'SpeechLexiconType',
    'eLEXTYPE_PRIVATE11', 'SREStreamEnd', 'SRAImport',
    'SAFTCCITT_uLaw_22kHzMono', 'SPEVENT', 'DISPID_SLGetWords',
    'SPPS_Function', 'SpObjectToken', 'SPEI_END_INPUT_STREAM',
    'SAFT44kHz16BitMono', 'DISPID_SLWWord', 'SpeechTokenShellFolder',
    'SDKLLocalMachine', 'DISPID_SWFEBlockAlign',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'SGDSActiveUserDelimited', 'DISPID_SPERetainedSizeBytes',
    'eLEXTYPE_VENDORLEXICON', 'DISPID_SLWType', 'DISPID_SWFEChannels',
    'DISPID_SpeechGrammarRules', 'DISPID_SASFreeBufferSpace',
    'ISpeechGrammarRuleState', 'IEnumSpObjectTokens',
    'ISpObjectToken', 'DISPID_SPIStartTime', 'SDTPronunciation',
    'ISpeechRecoResultDispatch', 'SAFT11kHz8BitMono', 'ISpRecoResult',
    'DISPID_SLGenerationId', 'SSTTTextBuffer', 'SAFT11kHz16BitStereo',
    'SPSSuppressWord', 'SPPS_NotOverriden', 'SVEPrivate',
    'SRAInterpreter', 'SVP_21', 'DISPID_SVSInputSentenceLength',
    'SSFMCreate', 'DISPID_SPPBRestorePhraseFromMemory',
    'SAFT32kHz8BitStereo', 'SpeechWordType',
    'DISPID_SpeechPhraseInfo', 'SPBOOKMARKOPTIONS',
    'SVEStartInputStream', 'SpeechAddRemoveWord', 'IEnumString',
    'SPEI_RECOGNITION', 'DISPID_SPIProperties',
    'DISPID_SVSLastResult', 'DISPID_SRRSpeakAudio',
    'DISPID_SPAPhraseInfo', 'DISPID_SpeechLexiconWord',
    'ISpeechPhraseProperty', 'SpPhoneConverter', 'SBOPause',
    'DISPID_SGRsFindRule', 'ISpObjectWithToken', 'SP_VISEME_6',
    'SVP_20', 'SRTReSent', 'DISPID_SOTsCount',
    'DISPID_SRCEventInterests', 'SVESentenceBoundary', 'tagSTATSTG',
    'SAFT44kHz8BitMono', 'DISPID_SGRsCommitAndSave',
    'DISPID_SMSALineId', '__MIDL_IWinTypes_0009',
    'DISPID_SRSClsidEngine', 'DISPID_SWFEAvgBytesPerSec',
    'DISPID_SGRAddState', 'SPINTERFERENCE_NONE', 'DISPID_SAFGuid',
    'DISPID_SRCEPhraseStart', 'DISPID_SPELexicalForm',
    'SAFT12kHz16BitStereo', 'SRADynamic', 'SAFT32kHz16BitStereo',
    'SPEI_VISEME', 'eLEXTYPE_PRIVATE4', 'SPRECOCONTEXTSTATUS',
    'DISPID_SRCEInterference', 'SP_VISEME_4', 'SpSharedRecognizer',
    'DISPID_SVPriority', 'SP_VISEME_3', 'DISPID_SGRClear',
    'SAFT11kHz8BitStereo', 'SPSHT_EMAIL',
    'DISPID_SREmulateRecognition', 'SDTLexicalForm',
    'DISPID_SpeechPhoneConverter', 'DISPID_SpeechMemoryStream',
    'SAFT8kHz16BitStereo', 'SPPARTOFSPEECH', 'DISPID_SRProfile',
    'SPWT_DISPLAY', 'SPPS_Unknown', 'SpeechCategoryAudioIn',
    'SpeechEngineConfidence', 'SPCONTEXTSTATE', 'SGPronounciation',
    'SPINTERFERENCE_NOISE', 'ISpeechRecoResultTimes', 'SLOStatic',
    'eLEXTYPE_PRIVATE18', 'DISPID_SVIsUISupported', 'ISpMMSysAudio',
    'SRERecoOtherContext', 'SPBO_PAUSE', 'DISPID_SVSInputWordLength',
    'ISpeechPhraseRules', 'DISPID_SPRsCount', 'eLEXTYPE_APP',
    ...
    'DISPID_SpeechVoiceEvent', 'SVSFParseSsml',
    'SDA_Consume_Leading_Spaces', 'DISPID_SLWsItem',
    'DISPID_SpeechAudioStatus', 'DISPID_SMSGetData', 'SpShortcut',
    'DISPID_SpeechCustomStream', 'SpeechPartOfSpeech',
    ...
    'SRERequestUI', 'SRESoundEnd', 'DISPID_SpeechPhraseBuilder',
    'DISPID_SpeechPhraseElements', 'DISPID_SPRNumberOfElements',
    'SAFT16kHz8BitStereo', 'SP_VISEME_17', 'SAFT22kHz16BitMono',
    'DISPID_SVESentenceBoundary', 'DISPID_SRSNumberOfActiveRules',
    'DISPID_SVSyncronousSpeakTimeout', 'SPAS_PAUSE',
    'DISPID_SASState', 'DISPID_SGRsDynamic', 'SpPhraseInfoBuilder',
    'DISPID_SpeechVoice', 'SLODynamic', 'SP_VISEME_7',
    'SPFM_CREATE_ALWAYS', 'ISpNotifySource', 'SpFileStream',
    'SPCATEGORYTYPE', 'tagSPPROPERTYINFO', 'SpeechVisemeFeature',
    'SPWAVEFORMATTYPE', 'SpeechStreamSeekPositionType',
    'SPAUDIOSTATUS', 'SGDSActive', 'DISPID_SABIMinNotification',
    'DISPID_SLPs_NewEnum', 'ISpeechRecoGrammar',
    'DISPID_SPEs_NewEnum', 'SPEI_TTS_AUDIO_LEVEL',
    'DISPID_SAFGetWaveFormatEx', 'eLEXTYPE_PRIVATE17',
    'SpeechEmulationCompareFlags', 'DISPID_SVAlertBoundary',
    'DISPID_SVSpeakCompleteEvent', 'DISPID_SRCESoundEnd',
    'DISPID_SVAudioOutputStream', 'DISPID_SPPParent',
    'DISPID_SLPLangId', 'SpeechBookmarkOptions', 'DISPID_SGRsCount',
    'ISpLexicon', 'SPWT_LEXICAL', 'SpStream', 'SREAudioLevel',
    'SVF_Emphasis', 'DISPID_SFSOpen', 'eWORDTYPE_DELETED',
    'SVEEndInputStream', 'eLEXTYPE_RESERVED4', 'SPEI_SOUND_START',
    'DISPID_SLRemovePronunciation', 'SPBO_AHEAD', 'SAFT48kHz8BitMono',
    'DISPID_SVVolume', 'SpeechAudioProperties',
    'DISPID_SVEventInterests', 'SVP_1', 'SDTAlternates',
    'STCLocalServer', 'DISPID_SOTGetAttribute',
    'DISPID_SRCERequestUI', 'DISPID_SRGCmdSetRuleState',
    'eLEXTYPE_RESERVED7', 'DISPID_SPIAudioSizeTime',
    'SPEI_ADAPTATION', 'DISPID_SGRs_NewEnum',
    'DISPID_SDKGetBinaryValue', 'SPEI_WORD_BOUNDARY', 'DISPID_SOTCId',
    'DISPID_SRSSupportedLanguages', 'SPSHORTCUTPAIR',
    'SAFTNoAssignedFormat', 'DISPID_SRCERecognition', 'SPFM_CREATE',
    'DISPID_SWFESamplesPerSec', 'DISPID_SBSSeek',
    'DISPID_SRCEHypothesis', 'SVSFIsNotXML', 'SAFT24kHz16BitMono',
    'SPWF_SRENGINE', 'SLTApp', 'DISPID_SDKSetStringValue',
    'DISPID_SGRInitialState', 'SVP_5', 'DISPID_SRCBookmark',
    'SPTEXTSELECTIONINFO', 'SPLO_DYNAMIC', 'SASClosed', 'SVP_8',
    ...
    'SAFTADPCM_22kHzMono', 'DISPID_SGRSTs_NewEnum', 'DISPIDSPRG',
    'SPEVENTSOURCEINFO', 'ISpeechCustomStream', 'SRADefaultToActive',
    'SPRECORESULTTIMES', 'SPPS_Noun', 'SpeechCategoryAppLexicons',
    'DISPID_SpeechPhraseElement',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SAFTCCITT_ALaw_11kHzMono', 'DISPID_SRCRetainedAudio',
    'DISPID_SPAStartElementInResult', 'SPEI_RESERVED3',
    'SPEI_START_INPUT_STREAM', 'DISPID_SMSSetData',
    'DISPID_SOTs_NewEnum', 'SAFT11kHz16BitMono',
    'ISpeechTextSelectionInformation', 'SP_VISEME_15',
    'STCInprocHandler', 'SITooFast', 'eLEXTYPE_USER', 'LONG_PTR',
    'SPEI_END_SR_STREAM', 'DISPID_SPRulesItem', 'SPSHT_NotOverriden',
    'SVSFlagsAsync', 'SPFM_OPEN_READONLY', 'SPRECOGNIZERSTATUS',
    'SAFT48kHz16BitStereo', 'SPDKL_LocalMachine', 'SpeechRecoEvents',
    'SREAdaptation', 'SWTDeleted', 'SITooSlow', 'eLEXTYPE_PRIVATE19',
    'DISPID_SAFSetWaveFormatEx', 'DISPID_SPCLangId', 'SSTTWildcard',
    'DISPID_SLPType', 'SAFT22kHz8BitStereo', 'SPRST_ACTIVE_ALWAYS',
    'DISPID_SpeechPhraseProperty', 'DISPID_SRDisplayUI',
    'DISPID_SRGRecoContext', 'SPAR_Unknown', 'SECFIgnoreKanaType',
    'SPPS_Modifier', 'ISpeechRecognizer', 'SPGRAMMARSTATE',
    'SDKLCurrentUser', 'DISPID_SPRFirstElement', 'DISPID_SRGCommit',
    'DISPID_SpeechMMSysAudio', 'DISPID_SpeechGrammarRuleState',
    'SREStreamStart', 'SPPHRASEELEMENT',
    'DISPID_SpeechPhraseAlternate', 'ISpeechPhraseReplacements',
    'SAFT16kHz16BitMono', 'STCAll', 'SWPUnknownWordUnpronounceable',
    'SRATopLevel', 'DISPID_SPPName', 'SRCS_Disabled', 'SP_VISEME_5',
    'DISPID_SPIAudioStreamPosition', 'ISpProperties',
    'SPEI_SR_AUDIO_LEVEL', 'STCInprocServer', 'ISpXMLRecoResult',
    'ISpeechLexiconPronunciations', 'ISpeechRecoResult2',
    'SPEI_UNDEFINED', 'DISPID_SRIsUISupported', 'ISpeechRecoContext',
    'DISPID_SVAudioOutput', 'DISPID_SVEWord', 'SGRSTTRule',
    'SECHighConfidence', 'SGDSActiveWithAutoPause', 'DISPID_SRStatus',
    'SpObjectTokenCategory', 'DISPID_SRGDictationUnload',
    'ISpNotifySink', 'SPSMF_SAPI_PROPERTIES', 'SVPNormal',
    'DISPID_SpeechWaveFormatEx', 'STSF_AppData',
    'SpeechAudioFormatType', 'SpPhoneticAlphabetConverter',
    'DISPID_SPRuleParent', 'ISpeechFileStream', 'eLEXTYPE_PRIVATE6',
    ...
    'SDTProperty', 'SPSVerb', 'DISPID_SVEPhoneme',
    'SPWORDPRONUNCIATIONLIST', 'SPRS_INACTIVE',
    'SAFTCCITT_ALaw_8kHzStereo',
    'DISPID_SpeechGrammarRuleStateTransition',
    'SPRST_INACTIVE_WITH_PURGE', 'SPPS_Interjection', 'SpMMAudioOut',
    'SPEI_MIN_SR', 'SPSLMA', 'SpSharedRecoContext', 'SPSInterjection',
    'eLEXTYPE_PRIVATE7', 'STSF_CommonAppData', 'DISPID_SVSkip',
    'SpMMAudioIn', 'eLEXTYPE_RESERVED10',
    'DISPID_SGRSAddWordTransition', 'DISPID_SRCEBookmark',
    'SAFT8kHz8BitStereo', 'SPVPRI_ALERT', 'SPPS_SuppressWord',
    'SECNormalConfidence', 'SVP_12', 'DISPID_SVGetProfiles',
    'Speech_StreamPos_RealTime', 'DISPIDSPTSI',
    'DISPID_SpeechLexiconWords', 'ISpeechAudioFormat',
    ...
    'SREPhraseStart', 'DISPID_SRRSetTextFeedback', 'SSTTDictation',
    ...
    'DISPID_SpeechAudioBufferInfo', 'DISPID_SPPConfidence',
    'SVSFVoiceMask', 'eLEXTYPE_PRIVATE12', 'DISPID_SVEEnginePrivate',
    'ISpeechPhraseRule', 'SpVoice', 'SpMMAudioEnum',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'SpeechRegistryLocalMachineRoot', 'SRTAutopause',
    'ISpeechGrammarRuleStateTransition', 'SPAS_STOP',
    'DISPID_SVGetAudioOutputs', 'SP_VISEME_0', 'SAFTDefault',
    'SAFT8kHz16BitMono', 'eLEXTYPE_USER_SHORTCUT',
    'SpInprocRecognizer', 'DISPID_SpeechRecoContext',
    'DISPID_SWFEBitsPerSample', 'DISPID_SMSAMMHandle', 'SPCT_SLEEP',
    'SP_VISEME_14', 'SREAllEvents', 'SRTSMLTimeout', 'SRESoundStart',
    'SP_VISEME_10', 'SP_VISEME_9', 'DISPID_SOTsItem', 'SpAudioFormat',
    'SAFTCCITT_uLaw_44kHzMono', 'SVP_14', 'SPEI_PHRASE_START',
    'DISPID_SpeechRecognizer', 'SAFTNonStandardFormat',
    'DISPID_SPRuleChildren', 'SpeechMicTraining', 'DISPID_SPRText',
    'DISPID_SPPsCount', 'ISpRecoContext2', 'DISPID_SGRSTNextState',
    'SpeechGrammarTagWildcard', 'SRCS_Enabled', 'SPAO_RETAIN_AUDIO',
    'IStream', 'ISpSerializeState', 'SPEVENTENUM',
    'DISPID_SGRSTsCount', 'DISPID_SOTCategory',
    'DISPID_SRCERecognizerStateChange', 'SDTAudio',
    'DISPID_SpeechObjectTokenCategory', 'SP_VISEME_2',
    'SDKLDefaultLocation', 'SWTAdded', 'ISpRecoContext',
    'ISpeechDataKey', 'ISpPhraseAlt', 'DISPID_SRState',
    'DISPID_SRRTOffsetFromStart', 'SPRST_ACTIVE',
    '_ISpeechRecoContextEvents', 'SPEI_RESERVED2',
    'SPWORDPRONUNCIATION', 'SAFT12kHz8BitStereo',
    'SAFTCCITT_uLaw_11kHzStereo', 'DISPID_SRCRecognizer',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SPRS_ACTIVE_USER_DELIMITED',
    'eLEXTYPE_PRIVATE3', 'SAFT12kHz16BitMono', 'SPWF_INPUT',
    'SPAUDIOBUFFERINFO', 'SPPHRASE', 'SRSInactive',
    'DISPID_SDKSetLongValue', 'SpNotifyTranslator',
    'ISpeechVoiceStatus', 'SAFTGSM610_11kHzMono',
    'DISPID_SRRRecoContext', 'DISPID_SAFType', 'SpInProcRecoContext',
    'SVP_16', 'DISPID_SpeechRecoResult2', 'DISPID_SPRulesCount',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'DISPID_SPPEngineConfidence',
    'ISpEventSink', 'DISPID_SPEAudioSizeTime',
    'DISPID_SRCAudioInInterferenceStatus', 'SVSFIsFilename',
    'SPPS_RESERVED4', 'DISPID_SRGSetWordSequenceData',
    'SPSERIALIZEDRESULT', 'DISPID_SpeechRecognizerStatus',
    'SPAO_NONE', 'ISpRecoGrammar', 'SPINTERFERENCE_TOOQUIET',
    'DISPID_SOTDisplayUI', 'DISPID_SVWaitUntilDone',
    'SPEI_HYPOTHESIS', 'DISPID_SOTGetDescription',
    'DISPID_SDKGetStringValue', 'DISPID_SLWs_NewEnum',
    'DISPID_SPAsItem', 'SPINTERFERENCE_NOSIGNAL', 'DISPID_SOTCSetId',
    'SpeechTokenKeyAttributes', 'SVSFParseMask', 'DISPID_SGRSTWeight',
    'SpeechFormatType', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'SPINTERFERENCE_TOOFAST', 'DISPID_SVSpeakStream', 'SP_VISEME_13',
    'SECFDefault', 'DISPID_SGRAttributes', 'SPCT_SUB_DICTATION',
    'SAFTADPCM_8kHzMono', 'SPSNoun', 'DISPID_SpeechPhraseReplacement',
    'DISPID_SLPsItem', 'DISPIDSPTSI_ActiveLength',
    'DISPID_SRCERecognitionForOtherContext',
    'DISPID_SPPNumberOfElements', 'tagSPTEXTSELECTIONINFO',
    'DISPID_SRCCreateResultFromMemory'
]

_check_version('1.1.14', 1625019167.900314)
